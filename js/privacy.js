(() => {
    ...
    banner.innerHTML = `<div class="cookie-copy"><p>Мы используем файлы cookie и Яндекс.Метрику для анализа посещаемости и улучшения работы сайта. Аналитика включается только с вашего согласия. <a href="${privacyUrl.href}">Подробнее</a></p>
